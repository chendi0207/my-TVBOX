var rule={
    ...
    play_parse:true,
        ...
        var apiurl = 'https://www.kuaikanys.net/jiexi/jiekou-1/api.php';
        var purl = JSON.parse(request(apiurl, {
            headers: {
                'Referer': 'https://www.kuaikanys.net/jiexi/jiekou-1/?url='
            },
            body: 'url=' + url + '&ac=jx',
            method: 'POST'
        })).url;
    ...
    搜索:'.show&&ul&&li;a&&title;img&&src;.score&&Text;a&&href',
    // 搜索:'*;*;*;*;*',
}